...
class TestNeuroCoherence:
    ...
    def test_calculate_with_scalars(self):
        ...
        result = nc.calculate(gamma=1.2, theta=0.9, delta=0.3, lambda_op=0.85)
...
class TestRecoverySimulation:
    ...
    def test_simulate_recovery(self):
        ...
        result = nc.simulate_recovery_curve(
            initial_psi=0.3, target_psi=0.85, duration=100
        )
    ...
    def test_recovery_rate_effect(self):
        ...
        slow = nc.simulate_recovery_curve(
            initial_psi=0.3, target_psi=0.85, duration=100, recovery_rate=0.005
        )

        fast = nc.simulate_recovery_curve(
            initial_psi=0.3, target_psi=0.85, duration=100, recovery_rate=0.05
        )
...
class TestPerturbation:
    ...
    def test_perturbation_strength(self):
        ...
        weak = nc.apply_perturbation(
            baseline_trajectory=baseline, perturbation_time=100, strength=0.2
        )

        strong = nc.apply_perturbation(
            baseline_trajectory=baseline, perturbation_time=100, strength=0.8
        )
